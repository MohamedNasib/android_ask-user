...
import com.wesal.askhail.databinding.SectionAdvertBinding
...
class AdvertsListAdapter2(
    private val lists: MutableList<AdvertModel?>,
    private val isBusiness: Boolean,
    private val callBacks: OnAdvertCallBack?
)

    : RecyclerView.Adapter<AdvertsListAdapter2.HolderView>() {



    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderView {
        val itemBinding = SectionAdvertBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class HolderView(private val itemBinding: SectionAdvertBinding) :
