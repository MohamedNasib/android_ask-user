...
import com.wesal.askhail.databinding.RowSubSectionCircleBinding
import com.wesal.entities.models.SectionModel

class SubSectionAdapterCircle(
    private val list: MutableList<SectionModel?>,
    private val callBack: OnSubSectionClicked?
)

    : RecyclerView.Adapter<SubSectionAdapterCircle.HolderView>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderView {
        val itemBinding =
            RowSubSectionCircleBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class HolderView(private val itemBinding: RowSubSectionCircleBinding) :
